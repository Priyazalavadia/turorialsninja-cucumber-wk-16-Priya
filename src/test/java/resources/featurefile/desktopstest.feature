...
Feature: Desktops Test
  As a user I want to arrange listing in alphabetical order and verify product added to shopping cart

  @sanity
  Scenario:  USer can verify product arrange in alphabatical order
